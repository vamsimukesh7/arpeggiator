  ...
  _create_class(Game, [
    ...
    },
    {
      ...
      value: function _setupDOM() {
        ...
        this.videoElement.style.filter = "none"; // Make it black and white
                  ...
                  new Promise(function (resolve) {
                    _this.videoElement.onloadedmetadata = function () {
                      ...
                      _this.videoElement.style.width =
                        _this.renderDiv.clientWidth + "px";
                      _this.videoElement.style.height =
                        _this.renderDiv.clientHeight + "px";
                      resolve();
                    };
                  }),
                ];
              ...
              _loop = function (i) {
                ...
                if (results.landmarks && results.landmarks[i]) {
                  ...
                  if (
                    ...
                    _this1.lastLandmarkPositions[i] = currentRawLandmarks.map(
                      function (lm) {
                        return _object_spread({}, lm);
                      }
                    );
                  }
                  var smoothedLandmarks = currentRawLandmarks.map(function (
                    lm,
                    lmIndex
                  ) {
                    ...
                    return {
                      x:
                        ...
                        (1 - _this.smoothingFactor) * prevLm.x,
                      y:
                        _this.smoothingFactor * lm.y +
                        (1 - _this.smoothingFactor) * prevLm.y,
                      z:
                        _this.smoothingFactor * lm.z +
                        (1 - _this.smoothingFactor) * prevLm.z,
                    };
                  });
                  _this1.lastLandmarkPositions[i] = smoothedLandmarks.map(
                    function (lm) {
                      return _object_spread({}, lm);
                    }
                  );
                  ...
                  var handX =
                    (1 - normX_visible) * canvasWidth - canvasWidth / 2;
                  var handY =
                  ...
                  if (i === 0) {
                    ...
                    var note =
                      scale[Math.max(0, Math.min(scale.length - 1, noteIndex))];
                    ...
                    if (!isFistNow) {
                      ...
                      var arpeggioIsActive =
                        _this1.musicManager.activePatterns.has(i);
                    ...
                    var fingerStates =
                      _this1._getFingerStates(smoothedLandmarks);
    ...
    },
    {
      ...
      value: function _getFingerStates(landmarks) {
        ...
        try {
          for (
            var _iterator = Object.entries(fingertips)[Symbol.iterator](),
              _step;
    ...
    },
    {
      ...
      value: function _isFist(landmarks) {
        ...
        var fingertipsIndices = [4, 8, 12, 16, 20]; // Thumb, Index, Middle, Ring, Pinky
        ...
        try {
          for (
            var _iterator = fingertipsIndices[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
    ...
    },
    {
      ...
      value: function _updateHandLines(
        ...
        var points3D = landmarks.map(function (lm) {
          ...
          var normX_visible =
            (lmOriginalX - videoParams.offsetX) / videoParams.visibleWidth;
          var normY_visible =
            (lmOriginalY - videoParams.offsetY) / videoParams.visibleHeight;
        ...
        if (wristPos) {
          ...
          if (handIndex === 0 && thumbPos && indexPos) {
            ...
            if (isFist) {
              var fistLabel = this._createTextSprite(
    ...
    },
    {
      ...
      value: function _updateBeatIndicator() {
        ...
        var drumPriority = ["kick", "snare", "clap", "hihat"];
        this.beatIndicators.forEach(function (indicator, i) {
          ...
          try {
            for (
              var _iterator = drumPriority[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
